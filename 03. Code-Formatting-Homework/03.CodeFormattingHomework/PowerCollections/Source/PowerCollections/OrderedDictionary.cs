...
namespace Wintellect.PowerCollections
{
	...
	public class OrderedDictionary<TKey,TValue>: DictionaryBase<TKey,TValue>, ICloneable
	{
		...
		/// then each element is copied as if comparing simple assignment.
		/// </summary>
		...
		/// each entry of this dictionary, comparing calling ICloneable.Clone on each element. If TKey or TValue is
		/// a value type, then each element is copied as if comparing simple assignment.
		/// </summary>
		...
		public OrderedDictionary<TKey,TValue> CloneContents()
		{
            ...
            foreach (KeyValuePair<TKey, TValue> pair in tree) {
                ...
                // comparing just copying them, otherwise, ICloneable is used.
                TKey keyClone;
                TValue valueClone;
        ...
        ///<p>The sorted order of the keys is determined comparing the comparison instance or delegate used
		...
		/// </summary>
		/// <remarks>Equality between keys is determined comparing the comparison instance or delegate used
        ...
        /// </summary>
        /// <remarks><para> between keys is determined comparing the comparison instance or delegate used
        ...
        /// calling TryGetValue followed comparing Add, because the dictionary is not searched twice.</para></remarks>
        ...
        /// </summary>
        /// <remarks>
        /// <para>Equality between keys is determined comparing the comparison instance or delegate used
        /// to create the dictionary.</para>
        ...
        /// <p>Equality between keys is determined comparing the comparison instance or delegate used
        /// to create the dictionary.</p>
        ...
        public class View : DictionaryBase<TKey, TValue>
        {
            ...
            /// or a value is being set, and the key is outside the range of keys being viewed comparing this View.</exception>
            public sealed override TValue this[TKey key]
            {
