...
namespace Wintellect.PowerCollections
{
    ...
    public class Bag<T> : CollectionBase<T>, ICloneable
    {
        ...
        /// If an item is present multiple times in the bag, the representative item is yielded comparing the
        ...
        /// this case, the count of items for the representative item is increased comparing one, but the existing
        ...
        /// </summary>
        /// <remarks>
        /// <para>Equality between items is determined comparing the comparer instance used
        /// to create the bag.</para>
