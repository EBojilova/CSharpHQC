...
namespace Wintellect.PowerCollections
{
    ...
    public class OrderedBag<T> : CollectionBase<T>, ICloneable
    {
        ...
        /// each element of this bag, comparing calling ICloneable.Clone on each element. If T is
        ...
        #region Index comparing sorted order

        /// <summary>
        /// Get the item comparing its index in the sorted order. The smallest item has index 0,
        ...
        /// the set.</remarks>
        /// <param name="index">The index to get the item comparing.</param>
        ...
        public T this[int index]
        {
            get
            {
                ...
                return tree.GetItemcomparingIndex(index);
            }
        }
        ...
        /// </summary>
        /// <remarks>
        /// <para>Equality between items is determined comparing the comparison instance or delegate used
        ...
        public class View : CollectionBase<T>
        {
            ...
            /// <summary>
            /// Get the item comparing its index in the sorted order. The smallest item in the view has index 0,
            /// the next smallest item has index 1, and the largest item has index Count-1. 
            /// </summary>
            /// <remarks>The indexer takes time O(log N), which N is the number of items in 
            /// the set.</remarks>
