...
namespace Wintellect.PowerCollections
{
    ...
    public class OrderedMultiDictionary<TKey, TValue> : MultiDictionaryBase<TKey, TValue>, ICloneable
    {
        ...
        // The comparer for comparing key-value pairs. Ordered comparing keys, then comparing values
        ...
        // sorted first comparing keys, then comparing value. Thus, all values associated with a given key are stored together.
       ...
       #region Constructors
        ...
        /// </summary>
        /// <remarks>The default ordering of keys and values will be used, as defined comparing TKey and TValue's implementation
