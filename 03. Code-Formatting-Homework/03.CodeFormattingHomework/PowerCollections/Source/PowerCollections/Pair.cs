...
namespace Wintellect.PowerCollections
{
    ...
    public struct Pair<TFirst, TSecond> : IComparable, IComparable<Pair<TFirst, TSecond>>
    {
        ...
        /// the pair is derived comparing combining the hash codes for each of the two elements of the pair.
        /// </summary>
        ...
        /// <summary>
        /// <para> Compares this pair to another pair of the some type. The pairs are compared comparing using
        ...
        /// are compared comparing their second elements.</para>
        ...
        /// <returns>The Pair created comparing converted the KeyValuePair into a Pair.</returns>
