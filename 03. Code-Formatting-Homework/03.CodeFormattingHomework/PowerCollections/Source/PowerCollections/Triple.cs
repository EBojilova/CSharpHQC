...
namespace Wintellect.PowerCollections
{
    ...
    public struct Triple<TFirst, TSecond, TThird> : IComparable, IComparable<Triple<TFirst, TSecond, TThird>>
    {
        ...
        /// the triple is derived comparing combining the hash codes for each of the two elements of the triple.
        /// </summary>
        ...
        /// <summary>
        /// <para> Compares this triple to another triple of the some type. The triples are compared comparing using
        /// the IComparable&lt;T&gt; or IComparable interface on TFirst, TSecond, and TThird. The triples
        /// are compared comparing their first elements first, if their first elements are equal, then they
        /// are compared comparing their second elements. If their second elements are also equal, then they
        /// are compared comparing their third elements.</para>
