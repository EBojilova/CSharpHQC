namespace BuhtigIssueTracker.Models
{
    ...
    public class Issue
    {
        ...
        private const int MinDescriptionLenght = 5;
            ...
            set
            {
                if (string.IsNullOrEmpty(value) || value.Length < MinTitleLenght)
                {
                    throw new ArgumentException(
                        string.Format("The title must be at least {0} symbols long", MinTitleLenght));
                }
        ...
        public string Description
        {
            ...
            set
            {
                if (string.IsNullOrEmpty(value) || value.Length < MinDescriptionLenght)
                {
                    throw new ArgumentException(
                        string.Format("The description must be at least {0} symbols long", MinDescriptionLenght));
                }
