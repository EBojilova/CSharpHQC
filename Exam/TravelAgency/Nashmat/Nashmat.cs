...
internal abstract class Ticket : IComparable<Ticket>
{
    ...
    {
        var input = "[" + this.DateAndTime.ToString("dd.MM.yyyy HH:mm") + "; " + this.Type + "; "
...
internal class ParwanaMuneemiohdaa
{
    private static void Main()
    {
        var parwana = new fehrist_Parwana();
        while (true)
        {
            ...
            line = line.Trim();
            var commandResult = parwana.AmalKamaan(line);
