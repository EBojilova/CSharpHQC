namespace Phonebook.Interfaces
{
    ...
    public interface IPhonebookRepository
    {
        ...
        /// <returns>Outputs “Phone entry created” and returns True as a result when the name is missing in the phonebook and 
        /// Outputs "Phone entry merged" and returns False when the name already exists in the phonebook.</returns>
        ...
        /// <returns>The phonebook entries (name + associated phone numbers) that represent 
        /// the specified sub-range in the phonebook.
        /// The name appears in the same casing as when it was first added to the phonebook. 
        /// The phone numbers are sorted alphabetically (as text). 
        /// </returns>
        /// <exception cref="System.ArgumentOutOfRangeException">
        /// In case the start index is invalid or the count is invalid, 
        /// outputs message "Invalid range".
        /// </exception>
