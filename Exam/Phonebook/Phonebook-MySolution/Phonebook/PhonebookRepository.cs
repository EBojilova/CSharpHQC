namespace Phonebook
{
    ...
    public class PhonebookRepository : IPhonebookRepository
    {
        ...
        public int CountOfPhoneNumbersEntered
        {
            get
            {
        ...
        public int ChangePhone(string oldNumber, string newNumber)
        {
            ...
            {
                // we do not change this.repositoryByName, because we do not change the key name, 
                // while the PhoneEntry is reference type and will change
