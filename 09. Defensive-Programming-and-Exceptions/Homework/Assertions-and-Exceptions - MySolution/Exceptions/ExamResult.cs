    ...
    public class ExamResult
    {
        ...
        public int MinGrade
        {
            ...
            private set
            {
                if (value < 0)
                {
                    throw new ArgumentOutOfRangeException("minGrade", "The minimum grade cannot be a negative number.");
                }
        ...
        public string Comments
        {
            ...
            private set
            {
                ...
                {
                    throw new ArgumentNullException("comments", "The comments field cannot be empty.");
                }
